...
PresentResult::PresentResult(int algorithmSwitch, int increasingProblemSize, int incrementator, int stepsNumber, int problemsSolvedInStep, double generatorRatio) {
...
void PresentResult::print(){
    std::cout<<algorithmSwitch<<"\t"<<increasingProblemSize<<"\t"<<incrementator<<"\t"<<stepsNumber<<"\t"<<problemsSolvedInStep<<std::endl;
}
